...
<form method="post" >
    ...
    if (!empty($_GET['rombel'])) {
        ...
        $cek = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM qw_absen WHERE id_rombel = '$_GET[rombel]' and tgl_absen = '$tgl_sekarang'"));
        if (@$cek['tgl_absen'] == $tgl_sekarang and $cek['id_rombel'] == $_GET['rombel']) {
            ...
            <table border="1" align="center">
                ...
                <?php
                $no = 0;
                $sql = "SELECT * FROM qw_siswa WHERE id_rombel = '$_GET[rombel]'";

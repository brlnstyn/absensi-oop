...
<table align="center" border="1">
	...
	<tr>
		...
		<td>
			<a href="?menu=rayon&edit&id=<?php echo $r['id_rayon']; ?>"><img src="../images/b_edit.png"></a>
		</td>
		<td>
			<a href="?menu=rayon&hapus&id=<?php echo $r['id_rayon']; ?>" onclick="return confirm('Hapus Data?')"><img src="../images/b_drop.png"></a>
		</td>
	</tr>
<?php } } ?>
</table>